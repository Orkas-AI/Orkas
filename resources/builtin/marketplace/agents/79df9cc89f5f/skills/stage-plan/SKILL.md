...
- `tracks` is an **object** `{narration, music, captions}` — NOT an array of track objects. Include only active tracks; omit or use `null` for disabled ones.
