...
const BEHAVIOR_SUITE_BY_TOOL: Record<string, string> = {
  ...
  library_save: 'test/main/model/library-save-tool.test.ts',
  ...
  research_verify_citations: 'test/main/model/core-agent/research-verify-tool.test.ts',
  ...
  inner_browser: 'test/main/features/group_chat/browser-tool.test.ts',
  ...
  connector_setup: 'test/main/features/group_chat/connector-setup-tool.test.ts',
  ...
  run_program: 'test/main/model/core-agent/run-program.test.ts',
};
