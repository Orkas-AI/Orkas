...
export const GOOGLE_ENTRIES: CatalogEntry[] = [
  ...
  // rationale and PC/CLAUDE.md §6.5.
  {
    ...
    description_es: "Conecta Gmail, Calendar, Docs, Sheets y Tasks con un solo consentimiento; los servicios también se pueden conectar por separado.",
    description_fr: "Connectez Gmail, Calendar, Docs, Sheets et Tasks avec un seul consentement ; chaque service peut aussi être connecté séparément.",
    description_ko: "한 번의 동의로 Gmail, Calendar, Docs, Sheets, Tasks를 연결합니다. 각 서비스를 별도로 연결할 수도 있습니다.",
    description_de: "Verbinden Sie Gmail, Calendar, Docs, Sheets und Tasks mit einer einzigen Zustimmung; die Dienste können auch einzeln verbunden werden.",
    description_ru: "Подключите Gmail, Calendar, Docs, Sheets и Tasks одним согласием; каждый сервис также можно подключить отдельно.",
    description_it: "Collega Gmail, Calendar, Docs, Sheets e Tasks con un unico consenso; i singoli servizi possono anche essere collegati separatamente.",
  ...
  },
  {
    ...
    description_es: "Consulta, crea y actualiza eventos de calendario y reuniones.",
    description_fr: "Consultez, créez et mettez à jour les événements du calendrier et les réunions.",
    description_ko: "캘린더 일정과 회의를 조회하고 만들고 수정합니다.",
    description_de: "Sehen Sie Kalendertermine und Besprechungen ein, erstellen und aktualisieren Sie sie.",
    description_ru: "Просматривайте, создавайте и обновляйте события календаря и встречи.",
    description_it: "Visualizza, crea e aggiorna eventi del calendario e riunioni.",
  ...
  },
  {
    ...
    description_es: "Lee, crea y gestiona documentos de Google Docs desde tus flujos de trabajo.",
    description_fr: "Consultez, créez et gérez des documents Google Docs depuis vos processus.",
    description_ko: "워크플로에서 Google Docs 문서를 읽고 만들고 관리합니다.",
    description_de: "Lesen, erstellen und verwalten Sie Google Docs in Ihren Abläufen.",
    description_ru: "Читайте, создавайте и управляйте документами Google Docs в рабочих процессах.",
    description_it: "Leggi, crea e gestisci documenti Google Docs dai tuoi flussi di lavoro.",
  ...
  },
  {
    ...
    description_es: "Usa hojas de cálculo como fuente de datos: lee y escribe celdas y fórmulas.",
    description_fr: "Utilisez des feuilles de calcul comme source de données : lisez et modifiez les cellules et les formules.",
    description_ko: "스프레드시트를 데이터 소스로 사용해 셀과 수식을 읽고 씁니다.",
    description_de: "Nutzen Sie Tabellen als Datenquelle – lesen und schreiben Sie Zellen und Formeln.",
    description_ru: "Используйте таблицы как источник данных: читайте и записывайте ячейки и формулы.",
    description_it: "Usa i fogli di calcolo come fonte di dati: leggi e scrivi celle e formule.",
  ...
  },
  {
    ...
    description_es: "Integra la gestión de tareas directamente en tus flujos de trabajo.",
    description_fr: "Intégrez la gestion des tâches directement à vos processus.",
    description_ko: "작업 관리를 워크플로에 직접 통합합니다.",
    description_de: "Integrieren Sie die Aufgabenverwaltung direkt in Ihre Abläufe.",
    description_ru: "Встройте управление задачами прямо в рабочие процессы.",
    description_it: "Integra la gestione delle attività direttamente nei tuoi flussi di lavoro.",
  ...
  },
  {
    ...
    description_es: "Consulta el tráfico de búsqueda: consultas, clics/impresiones/posición, indexación y estado de los mapas del sitio.",
    description_fr: "Consultez le trafic de recherche : requêtes, clics, impressions, position, état de l’indexation et des sitemaps.",
    description_ko: "검색 트래픽의 검색어, 클릭수·노출수·순위, 색인 생성 및 사이트맵 상태를 확인합니다.",
    description_de: "Prüfen Sie Suchzugriffe: Suchanfragen, Klicks/Impressionen/Position sowie Indexierungs- und Sitemap-Status.",
    description_ru: "Просматривайте поисковый трафик: запросы, клики, показы, позиции, состояние индексирования и карт сайта.",
    description_it: "Visualizza il traffico di ricerca: query, clic/impressioni/posizione, indicizzazione e stato delle sitemap.",
