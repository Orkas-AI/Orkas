...
export const DOMESTIC_COLLABORATION_ENTRIES: CatalogEntry[] = [
  {
    ...
    description_es: "Autoriza la CLI oficial de WeCom para mensajes, contactos, calendario, documentos, hojas de cálculo, correo, reuniones, tareas y almacenamiento de archivos.",
    description_fr: "Autorisez la CLI officielle WeCom pour les messages, les contacts, le calendrier, les documents, les feuilles de calcul, les e-mails, les réunions, les tâches et le stockage de fichiers.",
    description_ko: "공식 WeCom CLI에 메시지, 연락처, 캘린더, 문서, 스프레드시트, 메일, 회의, 작업, 드라이브 사용 권한을 부여합니다.",
    description_de: "Autorisieren Sie die offizielle WeCom-CLI für Nachrichten, Kontakte, Kalender, Dokumente, Tabellen, E-Mails, Besprechungen, Aufgaben und Dateiablage.",
    description_ru: "Авторизуйте официальный WeCom CLI для сообщений, контактов, календаря, документов, таблиц, почты, встреч, задач и диска.",
    description_it: "Autorizza la CLI ufficiale di WeCom per messaggi, contatti, calendario, documenti, fogli di calcolo, posta, riunioni, attività e spazio di archiviazione.",
  ...
  },
  {
    ...
    description_es: "Autoriza con la misma CLI oficial de Lark/Feishu; detecta la edición de la organización a partir de la cuenta usada al escanear y selecciona el punto de conexión correspondiente.",
    description_fr: "Autorisez l’accès avec la même CLI officielle Lark/Feishu ; elle détecte l’édition du locataire à partir du compte utilisé pour le scan et sélectionne le point de terminaison correspondant.",
    description_ko: "동일한 공식 Lark/Feishu CLI로 승인합니다. 스캔한 계정에서 테넌트 버전을 감지하고 해당 엔드포인트를 선택합니다.",
    description_de: "Autorisieren Sie den Zugriff mit derselben offiziellen Lark/Feishu-CLI; sie erkennt die Mandantenedition anhand des zum Scannen verwendeten Kontos und wählt den passenden Endpunkt.",
    description_ru: "Авторизуйтесь через тот же официальный Lark/Feishu CLI: он определяет редакцию организации по отсканированному аккаунту и выбирает соответствующий эндпоинт.",
    description_it: "Autorizza tramite la stessa CLI ufficiale Lark/Feishu; rileva l'edizione del tenant dall'account usato per la scansione e seleziona l'endpoint corrispondente.",
  ...
  },
  {
    ...
    description_es: "Opción de compatibilidad para conexiones de Lark creadas con versiones anteriores de Orkas; las conexiones nuevas usan la tarjeta unificada de Lark con detección automática.",
    description_fr: "Entrée de compatibilité pour les connexions Lark créées par d’anciennes versions d’Orkas ; les nouvelles connexions utilisent la fiche Lark unifiée avec détection automatique.",
    description_ko: "이전 Orkas 버전에서 생성한 Lark 연결을 위한 호환성 항목입니다. 새 연결은 자동 감지를 지원하는 통합 Lark 카드를 사용합니다.",
    description_de: "Kompatibilitätseintrag für Lark-Verbindungen aus älteren Orkas-Versionen; neue Verbindungen verwenden die einheitliche Lark-Karte mit automatischer Erkennung.",
    description_ru: "Запись для совместимости с подключениями Lark, созданными в старых версиях Orkas; новые подключения используют единую карточку Lark с автоматическим определением.",
    description_it: "Voce di compatibilità per le connessioni Lark create da versioni precedenti di Orkas; le nuove connessioni usano la scheda Lark unificata con rilevamento automatico.",
  ...
  },
  {
    ...
    description_es: "Autoriza la CLI oficial de DingTalk DWS para mensajes, contactos, calendario, documentos, hojas de cálculo, tareas, aprobaciones, asistencia, correo y wiki.",
    description_fr: "Autorisez la CLI officielle DingTalk DWS pour les messages, les contacts, le calendrier, les documents, les feuilles de calcul, les tâches, les approbations, la présence, les e-mails et le wiki.",
    description_ko: "공식 DingTalk DWS CLI에 메시지, 연락처, 캘린더, 문서, 스프레드시트, 작업, 승인, 근태, 메일, 위키 사용 권한을 부여합니다.",
    description_de: "Autorisieren Sie die offizielle DingTalk DWS-CLI für Nachrichten, Kontakte, Kalender, Dokumente, Tabellen, Aufgaben, Genehmigungen, Anwesenheit, E-Mails und Wiki.",
    description_ru: "Авторизуйте официальный DingTalk DWS CLI для сообщений, контактов, календаря, документов, таблиц, задач, согласований, учёта посещаемости, почты и вики.",
    description_it: "Autorizza la CLI ufficiale DingTalk DWS per messaggi, contatti, calendario, documenti, fogli di calcolo, attività, approvazioni, presenze, posta e wiki.",
