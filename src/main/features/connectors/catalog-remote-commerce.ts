...
export const REMOTE_COMMERCE_ENTRIES: CatalogEntry[] = [
  {
    ...
    description_es: "Gestiona campañas, perfiles, catálogos, flujos, suscripciones y datos de rendimiento.",
    description_fr: "Gérez les campagnes, les profils, les catalogues, les flux, les abonnements et les données de performance.",
    description_ko: "캠페인, 프로필, 카탈로그, 플로, 구독, 성과 데이터를 관리합니다.",
    description_de: "Verwalten Sie Kampagnen, Profile, Kataloge, Abläufe, Abonnements und Leistungsdaten.",
    description_ru: "Управляйте кампаниями, профилями, каталогами, потоками, подписками и данными эффективности.",
    description_it: "Gestisci campagne, profili, cataloghi, flussi, iscrizioni e dati sulle prestazioni.",
  ...
  },
  {
    ...
    description_es: "Gestiona pedidos, pagos, reembolsos, facturas, disputas, seguimiento y suscripciones de PayPal en producción.",
    description_fr: "Gérez les commandes, les paiements, les remboursements, les factures, les litiges, le suivi et les abonnements PayPal en production.",
    description_ko: "프로덕션 PayPal 주문, 결제, 환불, 청구서, 분쟁, 배송 추적, 구독을 관리합니다.",
    description_de: "Verwalten Sie PayPal-Bestellungen, Zahlungen, Erstattungen, Rechnungen, Streitfälle, Sendungsverfolgung und Abonnements in der Produktionsumgebung.",
    description_ru: "Управляйте производственными заказами PayPal, платежами, возвратами средств, счетами, спорами, отслеживанием доставки и подписками.",
    description_it: "Gestisci ordini, pagamenti, rimborsi, fatture, contestazioni, tracciamento e abbonamenti PayPal in produzione.",
  ...
  },
  {
    ...
    description_es: "Gestiona pedidos, pagos, reembolsos, facturas, disputas, seguimiento y suscripciones de prueba de PayPal Sandbox.",
    description_fr: "Gérez les commandes de test, les paiements, les remboursements, les factures, les litiges, le suivi et les abonnements PayPal Sandbox.",
    description_ko: "PayPal Sandbox 테스트 주문, 결제, 환불, 청구서, 분쟁, 배송 추적, 구독을 관리합니다.",
    description_de: "Verwalten Sie PayPal Sandbox-Testbestellungen, Zahlungen, Erstattungen, Rechnungen, Streitfälle, Sendungsverfolgung und Abonnements.",
    description_ru: "Управляйте тестовыми заказами PayPal Sandbox, платежами, возвратами средств, счетами, спорами, отслеживанием доставки и подписками.",
    description_it: "Gestisci ordini, pagamenti, rimborsi, fatture, contestazioni, tracciamento e abbonamenti di prova in PayPal Sandbox.",
  ...
  },
  {
    ...
    description_es: "Lee registros de ERP, informes, búsquedas guardadas y SuiteQL; crea o actualiza registros tras la confirmación.",
    description_fr: "Consultez les enregistrements ERP, les rapports, les recherches enregistrées et SuiteQL ; créez ou mettez à jour des enregistrements après confirmation.",
    description_ko: "ERP 레코드, 보고서, 저장된 검색, SuiteQL을 읽고 확인 후 레코드를 만들거나 업데이트합니다.",
    description_de: "Lesen Sie ERP-Datensätze, Berichte, gespeicherte Suchen und SuiteQL; erstellen oder aktualisieren Sie Datensätze nach Bestätigung.",
    description_ru: "Читайте записи ERP, отчёты, сохранённые поиски и SuiteQL; создавайте и обновляйте записи после подтверждения.",
    description_it: "Leggi record ERP, report, ricerche salvate e SuiteQL; crea o aggiorna record previa conferma.",
    ...
    connection_setup: {
      ...
      instructions_es: "Un administrador debe habilitar Server SuiteScript, OAuth 2.0 y REST Web Services. Autoriza un rol que no sea Administrator ni tenga todos los permisos, con los permisos MCP Server Connection y Log in using OAuth 2.0 Access Tokens; la lectura de registros también requiere REST Web Services y los permisos de los registros correspondientes.",
      instructions_fr: "Un administrateur doit activer Server SuiteScript, OAuth 2.0 et REST Web Services. Autorisez un rôle autre qu’Administrator, sans autorisations complètes, avec MCP Server Connection et Log in using OAuth 2.0 Access Tokens ; la lecture des enregistrements nécessite aussi REST Web Services et les autorisations correspondant aux enregistrements.",
      instructions_ko: "관리자가 Server SuiteScript, OAuth 2.0, REST Web Services를 활성화해야 합니다. Administrator가 아니며 전체 권한도 없는 역할에 MCP Server Connection 및 Log in using OAuth 2.0 Access Tokens 권한을 부여해 승인하세요. 레코드 읽기에는 REST Web Services와 해당 레코드 권한도 필요합니다.",
      instructions_de: "Ein Administrator muss Server SuiteScript, OAuth 2.0 und REST Web Services aktivieren. Autorisieren Sie eine Rolle, die weder Administrator ist noch uneingeschränkte Berechtigungen hat, mit MCP Server Connection und Log in using OAuth 2.0 Access Tokens; das Lesen von Datensätzen erfordert zusätzlich REST Web Services und die jeweiligen Datensatzberechtigungen.",
      instructions_ru: "Администратор должен включить Server SuiteScript, OAuth 2.0 и REST Web Services. Авторизуйте роль, не являющуюся Administrator и не имеющую полных разрешений, с правами MCP Server Connection и Log in using OAuth 2.0 Access Tokens; для чтения записей также нужны REST Web Services и соответствующие разрешения на записи.",
      instructions_it: "Un amministratore deve abilitare Server SuiteScript, OAuth 2.0 e REST Web Services. Autorizza un ruolo diverso da Administrator e privo di autorizzazioni complete, con MCP Server Connection e Log in using OAuth 2.0 Access Tokens; la lettura dei record richiede anche REST Web Services e le autorizzazioni pertinenti per i record.",
      ...
      guide_label_es: "Abrir la guía oficial del ID de cuenta de NetSuite",
      guide_label_fr: "Ouvrir le guide officiel du NetSuite Account ID",
      guide_label_ko: "NetSuite Account ID 공식 가이드 열기",
      guide_label_de: "Offiziellen Leitfaden zur NetSuite Account ID öffnen",
      guide_label_ru: "Открыть официальное руководство по NetSuite Account ID",
      guide_label_it: "Apri la guida ufficiale al NetSuite Account ID",
      ...
      fields: [{
        ...
        label_es: "ID de cuenta de NetSuite",
        label_fr: "ID de compte NetSuite",
        label_ko: "NetSuite Account ID",
        label_de: "NetSuite-Konto-ID",
        label_ru: "NetSuite Account ID",
        label_it: "NetSuite Account ID",
        ...
        help_es: "Encuéntralo en Configuración > Empresa > Información de la empresa. Para Sandbox, por ejemplo, 123456_SB1. Un administrador debe instalar MCP Standard Tools SuiteApp y habilitar un registro de integración DCR Public Client con Client Name: Orkas.",
        help_fr: "Trouvez-le sous Setup > Company > Company Information. Pour Sandbox, par exemple 123456_SB1. Un administrateur doit installer MCP Standard Tools SuiteApp et activer un enregistrement d’intégration DCR Public Client avec Client Name : Orkas.",
        help_ko: "Setup > Company > Company Information에서 확인하세요. Sandbox의 예는 123456_SB1입니다. 관리자가 MCP Standard Tools SuiteApp을 설치하고 Client Name이 Orkas인 DCR Public Client 연동 레코드를 활성화해야 합니다.",
        help_de: "Sie finden ihn unter Setup > Company > Company Information. Für Sandbox zum Beispiel 123456_SB1. Ein Administrator muss MCP Standard Tools SuiteApp installieren und einen DCR Public Client-Integrationsdatensatz mit Client Name: Orkas aktivieren.",
        help_ru: "Найдите в Setup > Company > Company Information. Для Sandbox, например, 123456_SB1. Администратор должен установить MCP Standard Tools SuiteApp и включить запись интеграции DCR Public Client с Client Name: Orkas.",
        help_it: "Trovalo in Setup > Company > Company Information. Per Sandbox, ad esempio 123456_SB1. Un amministratore deve installare MCP Standard Tools SuiteApp e abilitare un record di integrazione DCR Public Client con Client Name: Orkas.",
