---
name: agent-browser
description_zh: "无头浏览器自动化 CLI，专为 AI agent 设计：用 accessibility tree 快照 + ref 索引选择元素，稳定可控。适合\"打开网页填表单并提交\"\"自动点击导航抓内容\"\"端到端 web 测试\"；触发词：浏览器、自动化、表单、点击、导航、网页操作、accessibility、ref"
description_en: "Headless browser automation CLI optimized for AI agents: accessibility-tree snapshots with ref-based element selection for stable, deterministic flows. For: 'open this page, fill the form, submit', 'click through navigation and grab the content', 'run an end-to-end web test'; Triggers: browser, automation, form, click, navigation, web, accessibility, ref"
---
