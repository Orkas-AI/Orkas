...
description_zh: "创建、查看、编辑 Microsoft Excel 工作簿和 XLSX 文件，公式 / 日期 / 类型 / 格式 / 重算 / 模板都可靠。适合\"做一个 Excel 财务报表\"\"把 CSV 整理成带公式的 xlsx\"\"修改这个 .xlsx 文件并保留模板格式\"；触发词：excel、xlsx、xls、csv、tsv、表格、工作簿、公式、电子表格"
