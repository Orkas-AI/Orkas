...
(function () {
  ...
  const UI_ICONS = {
    ...
    monitor: '<rect x="2" y="3" width="20" height="14" rx="2"></rect><path d="M12 17v4M8 21h8"></path>',
    ...
    download: '<path d="M12 3v12m-5-5 5 5 5-5"></path><path d="M4 15v5h16v-5"></path>',
    ...
    'grip-vertical': '<g fill="currentColor" stroke="none"><circle cx="9" cy="5" r="1.5"></circle><circle cx="15" cy="5" r="1.5"></circle><circle cx="9" cy="12" r="1.5"></circle><circle cx="15" cy="12" r="1.5"></circle><circle cx="9" cy="19" r="1.5"></circle><circle cx="15" cy="19" r="1.5"></circle></g>',
    ...
    'clipboard-list': '<rect width="8" height="4" x="8" y="2" rx="1" ry="1"></rect><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"></path><path d="M12 11h4M12 16h4M8 11h.01M8 16h.01"></path>',
