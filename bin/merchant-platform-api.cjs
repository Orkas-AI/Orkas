...
const modules = [require('./rakuten-rms-api.cjs'), require('./yahoo-shopping-api.cjs'), require('./futureshop-api.cjs'), require('./qoo10-japan-api.cjs'), require('./base-shop-api.cjs'), require('./storefront-admin-api.cjs'), require('./magento-admin-api.cjs'), require('./temu-seller-api.cjs'),
